...
function main() 
{
	...
	EscribirEnArchivo("EQUIPO", "IP", "COMANDO", "DATO");
...
{	
	var fso2, comandos, fila, salir, obtenido, DATO, regular, re;
	...
	while ( comandos.AtEndOfStream != true )
	{
		...
		switch(MARCA) {
		  case "HUAWEI":
			//aca PARSEO
			regular = regexFile.Readline(); //lee la linea de la expresion regular
