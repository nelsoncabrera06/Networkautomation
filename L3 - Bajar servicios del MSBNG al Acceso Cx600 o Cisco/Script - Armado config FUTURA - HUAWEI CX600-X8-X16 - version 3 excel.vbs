...
' este script genera la configuracion FUTURA para un CX600-X8-X16
...
NombreArchivo_Salida = "OUTPUT - Config FUTURA CX600-X8-X16 - excel.txt"
...
Function funcion_configSUBINTERFACE(fileoutput) 'Modelo de ejemplo HUAWEI CX600-X8 - SPE2MU
	...
	if TRANSPORTE = "NO TIENE" then
		...
		fileoutput.Write "Subint	" & "control-vid " & CVLAN & " dot1q-termination" & vbCrLf 	
		...
		fileoutput.Write "Subint	" & "interface " & Subinterface_completa & vbCrLf ' ACA SE ARMA DIFERENTE SVLAN + CVLAN
		fileoutput.Write "Subint	" & "description " & Descripcion & vbCrLf
		fileoutput.Write "Subint	" & "shutdown " & vbCrLf
		fileoutput.Write "Subint	" & "bandwidth " & Bandwidth & vbCrLf
		fileoutput.Write "Subint	" & "control-vid " & CVLAN & " qinq-termination" & vbCrLf 'aca la CVLAN en realidad podria ser cualquier id
		fileoutput.Write "Subint	" & "qinq termination pe-vid " & SVLAN & " ce-vid " & CVLAN & vbCrLf ' SVLAN y CVLAN
		if VRF <> "NO TIENE" then fileoutput.Write "Subint	" & "ip binding vpn-instance " & VRF & vbCrLf  
		fileoutput.Write "Subint	" & "ip address " & IpWAN & " " & Mascara_WAN & vbCrLf
		fileoutput.Write "Subint	" & "arp broadcast enable " & vbCrLf
		fileoutput.Write "Subint	" & "trust upstream principal " & vbCrLf
...
Function funcion_estaticas(fileoutput) 
	...
	if Estatica(indice) <> "sin datos" then
		...
		Do While indice < Cant_estaticas
			...
			'en esta funcion entra con formato de /xx como mascara 32, 29, 24
			MASCARA_estatica = funcion_ConvertirMASCARA(MASCARA_estatica)
			' y sale con formato de punto 255.255.255.255, 255.255.255.248 etc
...
Function funcion_ConvertirMASCARA(MASCARA_estatica)
	...
	Select Case MASCARA_estatica
		...
		Case "25"
			MASCARA_estatica = "255.255.255.128"
		Case "24"
	...
	'255.255.255.252  11111111.11111111.11111111.11111100  /30 4  usable
	...
	'Msgbox MASCARA_estatica
	funcion_ConvertirMASCARA = MASCARA_estatica
End Function
